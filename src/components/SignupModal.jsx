      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden modal-content relative">
        ...
        <div className="flex flex-col lg:flex-row min-h-[600px]">
          ...
          <div className="lg:w-1/2 relative">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-r from-purple-600/80 to-pink-600/80 rounded-t-2xl lg:rounded-l-2xl lg:rounded-t-none" />
